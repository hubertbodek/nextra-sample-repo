...
const classes = {
  link: cn(
    "nx-flex nx-px-4 nx-py-2 nx-text-body2 nx-transition-colors [word-break:break-word]",
    "nx-cursor-pointer [-webkit-tap-highlight-color:transparent] [-webkit-touch-callout:none] contrast-more:nx-border",
  ),
  inactive: cn(
    "nx-rounded-none nx-text-gray-500 hover:nx-bg-gray-100 hover:nx-text-gray-900",
    "dark:nx-text-brand-gray-300 dark:hover:nx-bg-brand-gray-950 dark:hover:nx-text-white",
  ...
  active: cn(
    "nx-rounded-none nx-bg-primary-100 nx-text-primary-800 dark:nx-bg-brand-dark-600 dark:nx-text-white",
    "contrast-more:nx-border-primary-500 contrast-more:dark:nx-border-primary-500",
  ),
  list: cn("nx-flex nx-flex-col"),
  border: cn(
    "nx-relative before:nx-absolute before:nx-inset-y-1 before:nx-h-full before:nx-top-0",
    'before:nx-w-px before:nx-bg-gray-200 before:nx-content-[""] dark:before:nx-bg-brand-gray-950',
    "ltr:nx-pl-1.5 ltr:before:nx-left-0 rtl:nx-pr-1.5 rtl:before:nx-right-0",
  ),
};
  ...
  return (
    <li className={cn({ open, active })}>
      ...
      >
        ...
        <ArrowRightIcon
          className="nx-h-[18px] nx-min-w-[18px] nx-rounded-sm nx-p-0.5 hover:nx-bg-gray-800/5 dark:hover:nx-bg-transparent nx-stroke-brand-yellow-500"
          pathClassName={cn(
      ...
      <Collapse className="ltr:nx-pr-0 rtl:nx-pl-0 nx-pt-1" isOpen={open}>
        {Array.isArray(item.children) ? (
          <Menu
            className={cn(classes.border, "ltr:nx-ml-4 rtl:nx-mr-4")}
  ...
  return (
    <>
      {includePlaceholder && asPopover ? (
        <div className="max-xl:nx-hidden nx-h-0 nx-w-[290px] nx-shrink-0" />
      ) : null}
      {!asPopover && (
        <aside
          className={cn(
            "nextra-sidebar-container nx-hidden lg:nx-flex nx-flex-col",
            "md:nx-top-[84px] md:nx-shrink-0 motion-reduce:nx-transform-none",
            "nx-transform-gpu nx-transition-all nx-ease-in-out",
            "print:nx-hidden",
            showSidebar ? "md:nx-w-[256px]" : "md:nx-w-4",
        ...
        >
          <Collapse isOpen={showSidebar} horizontal>
            ...
            <FocusedItemContext.Provider value={focused}>
              ...
              >
                <div
                  className={cn(
                    "nextra-top-gradient nx-overflow-y-auto nx-overflow-x-hidden",
                    "nx-grow md:nx-max-h-[calc(100vh-var(--nextra-navbar-height)-env(safe-area-inset-bottom))]",
                    showSidebar ? "no-scrollbar" : "no-scrollbar",
                  )}
                >
                  <div
                    className={cn(
                      "nextra-bottom-gradient nx-overflow-y-auto nx-overflow-x-hidden",
                      "nx-py-4 nx-px-4 nx-grow md:nx-h-[calc(100vh-var(--nextra-navbar-height)-var(--nextra-menu-height)-45px)]",
                      showSidebar ? "no-scrollbar" : "no-scrollbar",
                    )}
                    ref={sidebarRef}
                  >
                    ...
                    {(!asPopover || !showSidebar) && (
                      <Menu
                        className="nextra-menu-desktop max-md:nx-hidden nx-gap-0.5"
          ...
          >
            ...
            <button
              className={cn(
                "nx-inline-flex nx-items-center nx-gap-2 nx-text-body2 nx-mb-4 nx-h-5",
