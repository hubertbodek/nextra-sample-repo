...
import { z } from 'zod'
import { Anchor,  Footer, Navbar, Search, TOC } from './components'
...
export const themeSchema = z.strictObject({
  ...
  afterContent: z.strictObject({
    component: z.custom<ReactNode>(...reactNode),
  }),
  beforeContent: z.strictObject({
    component: z.custom<ReactNode>(...reactNode),
  }),
