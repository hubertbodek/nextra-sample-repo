...
const config = {
  ...
  /** Enables hot reloading for local acmes without a build step */
  transpilePackages: ["@acme/nextra-theme", "react-syntax-highlighter"],
...
const chTheme = {
  ...
  colors: {
    ...
    "tab.inactiveBackground": "#16150eff",
    "tab.activeBorderTop": "#fbe331ff",
    "editorGroupHeader.tabsBackground": "#1b1a11ff",
  },
  tokenColors: [
    {
    ...
    {
      name: "coloring of the Java import and acme identifiers",
      scope: [
        "storage.modifier.import.java",
        "variable.language.wildcard.java",
        "storage.modifier.acme.java",
      ],
      settings: {
        foreground: "#d4d4d4",
      },
